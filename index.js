...
for(let i = 0; i < artists.length;
  i++){
    console.log(artists[i].includes('1900-2000'));{
      return artists[i];
    }
  }
...
artists.push('id: 28,name: Luis Garcia, years: 1992 - current day,genre: Web Design, nationality: Homo Sapien, bio: i like to eat. i also like to sleep.');
console/log(artists);
...
console.log(lotsofArt(artists, ' > 100 paintings'));
